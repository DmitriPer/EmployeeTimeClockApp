export enum ErrorCode {
  ...
  MANAGER_HAS_ACTIVE_REPORTS = 'MANAGER_HAS_ACTIVE_REPORTS',
  // Correction requests
  CORRECTION_REQUEST_PENDING = 'CORRECTION_REQUEST_PENDING',
  PERIOD_LOCKED = 'PERIOD_LOCKED',
  CANNOT_SELF_APPROVE = 'CANNOT_SELF_APPROVE',
  // Retroactive entry requests
  ENTRY_ALREADY_EXISTS = 'ENTRY_ALREADY_EXISTS',
  RETROACTIVE_REQUEST_PENDING = 'RETROACTIVE_REQUEST_PENDING',
